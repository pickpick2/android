...
fun SelectFrameScreen(
    ...
    Column(
        ...
        Text(
            text = stringResource(R.string.select_frame_title),
            style = Heading1
        )
        ...
        Row(
            ...
            Text(
                text = stringResource(R.string.select_frame_notice),
...
fun SelectFramePreview() {
    SelectFrameScreen(onNavigateToComplete = {})
}